  ...
  const plans = {
    free: {
      ...
      features: [
        ...
        { text: 'Basic recipe management', included: true },
    ...
    premium: {
      ...
      features: [
        ...
        { text: '🎟️ Coupon & deals finder', included: true, premium: true },
        { text: '🤖 AI recipe assistant', included: true, premium: true },
        ...
        { text: '📍 Track delivery status', included: true, premium: true },
        { text: '⭐ Save favorite stores', included: true, premium: true },
        { text: '⏰ Delivery time slots', included: true, premium: true },
        { text: '💵 Tip calculator', included: true, premium: true },
        ...
        { text: '📅 Visual meal calendar', included: true },
        { text: '💰 Budget goals & alerts', included: true },
